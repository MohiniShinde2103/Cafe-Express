...
<div class="container-fluid">
	<form action="" id="signup-frm">
		<div class="form-group">
			...
			<input type="text" name="first_name" required="" class="form-control"  onkeypress="return /[a-z]/i.test(event.key)">
		</div>
		<div class="form-group">
			<label for="" class="control-label">Lastname</label>
			<input type="text" name="last_name" required="" class="form-control"  onkeypress="return /[a-z]/i.test(event.key)">
		</div>
		<div class="form-group">
